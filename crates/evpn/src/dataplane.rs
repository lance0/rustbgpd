...
pub struct FdbNexthopDataplaneStatus {
    ...
    /// Count of rustbgpd-tagged L2 FDB-NHG kernel nexthops discovered
    /// during startup adoption / drift recovery but not yet associated
    /// with a live owned group. These are retained or cleaned by the
...
pub enum DataplaneOpKind {
    ...
    /// Create and stamp an ADR-0091 managed bridge.
    CreateManagedBridge {
        /// Linux bridge name.
        name: String,
    },
    /// Remove a rustbgpd-owned ADR-0091 managed bridge.
    RemoveManagedBridge {
        /// Linux bridge name.
        name: String,
    },
    ...
    /// Remove a rustbgpd-owned ADR-0091 managed VRF.
    RemoveManagedVrf {
        /// Linux VRF link name.
        name: String,
    },
    /// Create and stamp an ADR-0091 managed L3 VXLAN.
    CreateManagedL3Vxlan {
        /// Linux L3 VXLAN link name.
        name: String,
    },
    /// Remove a rustbgpd-owned ADR-0091 managed L3 VXLAN.
