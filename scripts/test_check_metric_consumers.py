...
class MetricConsumerContractTests(unittest.TestCase):
    ...
    def test_live_inventory_and_consumer_counts_are_exact(self):
        ...
        self.assertEqual(len(self.inventory), 216)
        self.assertEqual(
        ...
        self.assertEqual(len(self.public_doc_refs), 205)
        self.assertEqual(len(self.doc_refs), 205)
        consumers = self.dashboard_refs | self.rule_refs | self.doc_refs
        self.assertEqual(len(consumers), 210)
    ...
    def test_live_main_reports_the_exact_roster(self):
        ...
        self.assertIn("216 emitted families", stdout.getvalue())
        self.assertIn("205 normative-doc families", stdout.getvalue())
        self.assertIn("210 consumed, 6 justified raw diagnostics", stdout.getvalue())
