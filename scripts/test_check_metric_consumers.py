...
class MetricConsumerContractTests(unittest.TestCase):
    ...
    def test_live_inventory_and_consumer_counts_are_exact(self):
        ...
        self.assertEqual(len(self.inventory), 217)
        self.assertEqual(
        ...
        self.assertEqual(len(self.public_doc_refs), 206)
        self.assertEqual(len(self.doc_refs), 206)
        consumers = self.dashboard_refs | self.rule_refs | self.doc_refs
        self.assertEqual(len(consumers), 211)
    ...
    def test_live_main_reports_the_exact_roster(self):
        ...
        self.assertIn("217 emitted families", stdout.getvalue())
        self.assertIn("206 normative-doc families", stdout.getvalue())
        self.assertIn("211 consumed, 6 justified raw diagnostics", stdout.getvalue())
