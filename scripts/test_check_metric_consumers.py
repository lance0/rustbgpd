...
class MetricConsumerContractTests(unittest.TestCase):
    ...
    def test_live_inventory_and_consumer_counts_are_exact(self):
        ...
        self.assertEqual(len(self.inventory), 197)
        self.assertEqual(
        ...
        self.assertEqual(len(self.public_doc_refs), 186)
        self.assertEqual(len(self.doc_refs), 186)
        consumers = self.dashboard_refs | self.rule_refs | self.doc_refs
        self.assertEqual(len(consumers), 191)
    ...
    def test_live_main_reports_the_exact_roster(self):
        ...
        self.assertIn("197 emitted families", stdout.getvalue())
        self.assertIn("186 normative-doc families", stdout.getvalue())
        self.assertIn("191 consumed, 6 justified raw diagnostics", stdout.getvalue())
