...
class MetricConsumerContractTests(unittest.TestCase):
    ...
    def test_live_inventory_and_consumer_counts_are_exact(self):
        ...
        self.assertEqual(len(self.inventory), 220)
        self.assertEqual(
        ...
        self.assertEqual(len(self.public_doc_refs), 209)
        self.assertEqual(len(self.doc_refs), 209)
        consumers = self.dashboard_refs | self.rule_refs | self.doc_refs
        self.assertEqual(len(consumers), 214)
    ...
    def test_live_main_reports_the_exact_roster(self):
        ...
        self.assertIn("220 emitted families", stdout.getvalue())
        self.assertIn("209 normative-doc families", stdout.getvalue())
        self.assertIn("214 consumed, 6 justified raw diagnostics", stdout.getvalue())
