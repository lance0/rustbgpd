...
| Reload UPDATE-stall receipt (LAN-333) | Worst UPDATE-delivery gap at 700 route-server clients × 400k routes during a changed-policy SIGHUP under live churn: 0.77 s median / 0.85 s worst (< 1 s gate), zero session flaps; full repropagation wall and the indicted per-peer resync path documented | [`perf/reload-stall-2026-07.md`](perf/reload-stall-2026-07.md) |
