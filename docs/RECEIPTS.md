...
| Exact-export fanout memo (Criterion) | Real per-session exact probe baseline vs ordered prepared-attribute memo: 18%..32% faster across 1/8/64/256-peer shapes, with commands, confidence intervals, correctness fence, and checked-in CSV | [`perf/exact-export-fanout-2026-07.md`](perf/exact-export-fanout-2026-07.md) |
