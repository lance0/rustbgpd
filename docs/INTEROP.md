...
real BIRD 3.3.1 TCP-AO topology twice: the existing uninterrupted live-rotation
...
lifecycle against BIRD 3.3.1 on a Linux kernel with `CONFIG_TCP_AO=y`:
