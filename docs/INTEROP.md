...
| GoBGP ×3 + BIRD 2 | GoBGP 4.7.0, BIRD 2.0.12 | `tests/interop/m92-gobgp-v47-rs-differential.clab.yml` | Tested (M92, local) | Dual-stack route-server semantic differential | Exact source/target inventories and per-PDU EoRs authorize baseline/mutant/restore diffs; separate missing-EoR refusal | Official amd64 release hash pinned; synthetic evidence only |
