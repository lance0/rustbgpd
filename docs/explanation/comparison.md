...
[evpn-enablement.md](../project/evpn-enablement.md) for the EVPN gate ladder.
...
[^multihop-rustbgpd]: rustbgpd has no multihop knob because there is nothing
    ...
    See [CONFIGURATION.md](../reference/configuration.md) and
...
[^lg]: This row records a looking-glass surface the project itself
    ...
    ([OPERATIONS.md](../reference/operations.md#looking-glass-birdwatcher-shaped-rest-subset));
