...
| **M111** | SRv6 VPNv4/VPNv6 service reflection from FRR 10.7.1 through rustbgpd to GoBGP 3.37.0. Independent packet decoding proves receive capabilities, exact service/NLRI/IPv6-next-hop preservation, expected RR attributes, SID transposition against FRR allocation, withdrawals and session continuity. | Local/manual [procedure and receipt](../../tests/interop/m111-srv6-l3vpn-reflection/README.md). Script: `test-m111-srv6-l3vpn-reflection.sh`; no forwarding or EVPN L2 service claim. |
| **M112** | Controlled-source SRv6 L2 reflection harness: MAC-only Type 2, TLV6 / End.DT2U, typed RR visibility, malformed-input withdrawal and recovery with a survivor. | [Procedure](../../tests/interop/m112-srv6-l2-reflection/README.md); offline negative controls in CI. Live run pending; no interoperability receipt or forwarding claim. |
