...
| `ListManagedNetdevs` | `sensitive_read` | ADR-0091 managed EVPN netdev status — exposes desired bridge and fixed-VNI VXLAN names, ownership stamps, observed bridge/VXLAN protected attributes, and orphan/foreign/unsafe state. |
