...
| `[managed_netdevs]` | restart-required | ADR-0091 bridge-class config/status substrate is resolved at startup and reported by the dataplane actor; lifecycle create/adopt/reap is not live-mutable in this tranche. |
