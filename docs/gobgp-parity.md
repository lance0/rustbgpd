...
| VPN FlowSpec | Yes | No | |
| BGP-LS (RFC 9552) | Yes | Partial | ADR-0077 slice negotiates BGP-LS / BGP-LS VPN, stores opaque RFC 9552 NLRI/TLV objects, exposes them through `ListBgpLsRoutes` / `rbgp rib bgpls`, and reflects them to eligible negotiated peers; local IGP topology production remains deferred |
| SR Policy | Yes | No | |
| SRv6 MUP | Yes | No | |
