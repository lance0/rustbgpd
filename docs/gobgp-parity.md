...
| TCP-AO (RFC 5925) | No | Startup | rustbgpd applies ordered static-neighbor and direct dynamic-prefix TCP-AO keyrings on Linux startup sockets; singleton config remains compatible, while live rotation remains LAN-16 / #159 |
