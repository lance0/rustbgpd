...
### VXLAN-EVPN DC Fabric RR (~92% parity, added 2026-04)
...
3. **MAC mobility / sticky preservation interop** — unit tests cover the tiebreak; real 3-VTEP move scenario pending (Gate 3)
4. **Multi-homing (Type 1 EAD + Type 4 ES)** — wire codec done; interop pending (Gate 4)
