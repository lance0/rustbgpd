...
| Controlled raw source + GoBGP | GoBGP 3.37.0 | `tests/interop/m112-srv6-l2-reflection.clab.yml` | Prepared (M112; live run pending) | [Controlled SRv6 L2 reflection](../tests/interop/m112-srv6-l2-reflection/README.md) | MAC-only Type 2 with TLV6 / End.DT2U, full SID and IPv6 next hop; the harness checks exact wire preservation, typed RR visibility, malformed replacement withdrawal, recovery and a survivor route. Offline negative controls run in CI. | No live receipt yet; manual topology, controlled origination, no forwarding or complete EVPN-over-SRv6 claim |
