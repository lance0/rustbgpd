...
|---------|------------------|--------|
| Operator query wait histogram | Two reloads at 1,000 route-server peers and 400,000 IPv4 prefixes: 16 successful timed CLI calls reconcile exactly 24 operator-lane observations, with filtered histogram/phase evidence and binary hashes. A bounded instrumentation check, without a soak qualification or general deadline claim | [`artifacts`](perf/artifacts/operator-query-wait-2026-09-12/README.md) |
