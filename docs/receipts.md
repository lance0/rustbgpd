...
| [M111](../tests/interop/m111-srv6-l3vpn-reflection/README.md) | Two SRv6 L3VPN prefixes over IPv6 sessions: negotiated VPNv4 IPv6-next-hop reception, exact reflected Prefix-SID/NLRI/next-hop bytes, label-based SID reconstruction checked against FRR allocation, independent withdrawals and session survival. The [typed-view rerun](artifacts/interop/m111-srv6-l3vpn-typed-20260906T191107Z/README.md) ties CLI fields to wire and allocation state; the [original receipt](artifacts/interop/m111-srv6-l3vpn-20260906T172814Z/README.md) remains unchanged. No RR forwarding or EVPN L2 service claim. A [rerun with semantic eligibility](artifacts/interop/m111-srv6-eligibility-20260906T200426Z/README.md) preserves both valid transposed services. | FRR 10.7.1 + GoBGP 3.37.0 |
| [M112](../tests/interop/m112-srv6-l2-reflection/README.md) | Controlled-source MAC-only Type 2 with SRv6 L2 Service TLV6 / End.DT2U: exact announced service bytes, typed RR visibility, malformed replacement withdrawal, recovery, explicit withdrawal and a survivor route. [Raw local receipt](artifacts/interop/m112-srv6-l2-20260906T192025Z/README.md) includes withdrawal-key identity and session continuity; no forwarding or complete EVPN-over-SRv6 claim. The [semantic replacement receipt](artifacts/interop/m112-srv6-semantic-20260906T200333Z/README.md) proves retained invalid bytes and typed fields, selection/export exclusion, observer withdrawal, and recovery without survivor churn. | Raw source + GoBGP 3.37.0 |
...
| Honor-policy healthy serial walks | Two 1,000-peer eBGP cells at the pinned candidate: honor-only SIGHUP walks bounded at 84–86 ms with sparse probes and 149–158 ms under dense probe load; all 1,223 dense calls pass, including 27 strictly interior calls and 13 mixed-generation stats replies. Sparse timing passes but misses phase coverage; no soak or speedup claim | [`artifacts`](perf/artifacts/honor-policy-waits-2026-09-12/README.md) |
...
| Dual-stack route-server reload harness | Harness extension for one-session IPv4 + IPv6 unicast members with independent per-family completion, a filtering policy shape with named-withdrawal, leak, and bystander accounting, and wire- and bitmap-level empty-family, missing-prefix, and duplicate-prefix negative cases. The linked initial 20-member correctness receipt passed with 20/20 sessions, both families exact, zero decode errors, and all operator probes exit 0; the later operating receipt below records follow-through at the larger pinned shapes | [`perf/ixp-dualstack-2026-09.md`](perf/ixp-dualstack-2026-09.md), [`pinned shape and raw cells`](perf/artifacts/ixp-dualstack-2026-09/README.md) |
| Dual-stack policy-reload readiness | Final normal 200- and 700-member filtering runs passed the unchanged operating gate with complete health capture after tooling cleanup repairs; earlier failures remain archived. Separate diagnostic maximum service gap 26.012 ms exceeds the 25 ms soft target; historical timing comparisons are not paired A/B evidence | [`perf/ixp-dualstack-readiness-2026-09.md`](perf/ixp-dualstack-readiness-2026-09.md), [`artifacts`](perf/artifacts/ixp-dualstack-readiness-2026-09/README.md) |
