...
prep=/tmp/policy-noops-700-prep
out=/tmp/policy-noops-700-50-F
cd "$repo"
...
env -i PATH="$PATH" HOME="$HOME" \
    N_PEERS=700 TOTAL_PREFIXES=400400 CHANGED_PEERS=600 \
    PORT=1790 RELOADS=4 CONTROL_SECS=30 \
    GEN_DUALSTACK=1 RELOADSTALL_DUALSTACK=1 \
    RELOADSTALL_IPV4_PREFIXES=200200 \
...
gate_rc=0
python3 "$out/gate.py" "$out" 700 400400 200200 600 32 \
