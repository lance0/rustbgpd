...
# Normal:     build.sh /tmp/lan1588-readiness-build-UNIQUE
# Diagnostic: build.sh /tmp/lan1588-readiness-diagnostic-build-UNIQUE diagnostic
...
primary=/tmp/campaign-build-cache
