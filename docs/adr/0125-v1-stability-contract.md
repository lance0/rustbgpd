...
| E4 debt schedule | **Satisfied:** L1, L3, A1, A2, C1, D1, and D3 are complete; the scheduled v0.65 removal batch is finished | Keep ADR-0122 as the compatibility-debt ledger and apply its recorded lifetime policies to future entries |
