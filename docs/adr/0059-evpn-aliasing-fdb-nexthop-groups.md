...
**Status:** Accepted; slices 1-4 plus slice 3.5 shipped on main
(PRs #84, #86, #87, #88, #89, #91, #92, #93). Slice 1 (portable
intent + projection AF guard, PR #84), slice 2 (`nexthop_raw`
raw-netlink primitive, PR #86), slice 3a (state types + apply
