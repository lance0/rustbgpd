...
| [0132](0132-operator-read-path.md) | Where operator reads live — admission at each wait site versus a published read generation | Proposed (B now, C for named summary surfaces) | 2026-09-12 | Unstated |
