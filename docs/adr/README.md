...
| [0119](0119-rfc-8212-secure-default-config-epoch.md) | RFC 8212 secure-default config epoch | Accepted (representation shipped; activation proof-gated) | 2026-07-29 |
...
| [0127](0127-config-transaction-settlement-watchdog.md) | Config transaction settlement watchdog | Proposed | 2026-08-11 |
