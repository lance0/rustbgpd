...
Benchmarks run at v0.4.2; the RIB hot-path has been unchanged through v0.22.0
in ways that would invalidate these numbers, but the runs themselves have not
been re-executed against current main. Fresh runs against the v0.22.0 main and
