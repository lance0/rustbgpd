...
`docs/how-to/evpn-vtep-troubleshooting.md`); this watches the named link's
...
- `docs/reference/configuration.md` — `[[evpn_instances]]` / `[[evpn_ip_vrfs]]` /
  `[[ethernet_segments]]` fields and full predicate definitions.
- `docs/how-to/evpn-vtep-troubleshooting.md` — diagnosing `NotReady` and
  receive-path drops.
