...
[OPERATIONS.md](../reference/operations.md); this page gets you to the right
command.
...
Details: [OPERATIONS.md](../reference/operations.md#explain-a-best-path-decision).
...
[CONFIGURATION.md](../reference/configuration.md#ebgp_requires_policy--rfc-8212-explicit-policy-on-ebgp).
...
and
[OPERATIONS.md](../reference/operations.md#explain-an-import-decision-adr-0073).
