...
For current EVPN guidance, see the [EVPN fabric route reflector recipe](../cookbook/evpn-fabric-rr.md), [EVPN VTEP setup](evpn-vtep-setup.md), and the EVPN alpha boundary in the [stability guide](../reference/stability.md).
...
- [x] **Operational runbook** for the bidirectional VTEP path:
  ...
  runbook at `docs/how-to/evpn-vtep-troubleshooting.md` ties them to
...
- `docs/project/evpn-enablement.md` — gate ladder + still-ahead lists
...
- `docs/how-to/evpn-vtep-troubleshooting.md` — bidirectional VTEP runbook
- `docs/interop.md` — M36, M37 test coverage
- `docs/reference/known-issues.md` — by-design alpha limitations
