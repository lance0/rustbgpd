...
but fails closed under its own reason, `RIB selection-deferral release
stalled`, and records its readiness waits under the `selection_release` seam. Use the poll-duration histogram to distinguish many
