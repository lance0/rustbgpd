...
> see [`deployment.md`](../how-to/deployment.md).
...
[`docs/reference/rustbgpd.schema.json`](rustbgpd.schema.json) (also emitted by
...
```
taplo check --schema file://$PWD/docs/reference/rustbgpd.schema.json /etc/rustbgpd/config.toml
```
...
tracked in [`docs/project/roadmap.md`](../project/roadmap.md) as a follow-up.
...
either way; add `--strict` (see [deployment.md](../how-to/deployment.md)) to make any
...
sourcing live in [COMPARISON.md](../explanation/comparison.md).
...
- `"l2vpn_evpn"` — L2VPN EVPN (AFI 25, SAFI 70, RFC 7432). Two
  ...
  See [docs/explanation/use-cases.md](../explanation/use-cases.md) § "VXLAN-EVPN DC Fabric"
...
- `"l3vpn_ipv6_unicast"` — VPNv6 (AFI 2, SAFI 128, RFC 4659)
  ...
  or MPLS FIB (deliberate — see [docs/explanation/gobgp-parity.md](../explanation/gobgp-parity.md)).
...
[RFC_NOTES.md](rfc-notes.md#rfc-7947-232--rfc-8195--route-server-control-communities).
...
[security checklist](../how-to/deployment.md#security-checklist) in the deployment guide.
...
> (ADR-0054 §4). See
> [docs/how-to/evpn-vtep-setup.md](../how-to/evpn-vtep-setup.md) for the `ip link` recipe;
...
> ADR-0058 §3 predicates. See [docs/how-to/evpn-vtep-setup.md](../how-to/evpn-vtep-setup.md)
