...
- **Refuse newer, leave intact** (event history store, BLACKHOLE receipt):
  ...
  daemon runs without the feature it backs, or refuses to start when
  `[event_history].required = true`, rather than rewriting or quarantining
