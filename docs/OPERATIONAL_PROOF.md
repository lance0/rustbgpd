...
| MRT snapshot allocation control (LAN-572) | Control pending; no result claimed | The two-shape production-encoder timing protocol, separate opt-in diagnostics, allocator semantics, timed exclusions, artifact schema, and predeclared ABBA/noise and GO/HOLD rules are in [`perf/mrt-snapshot-allocation-2026-07.md`](perf/mrt-snapshot-allocation-2026-07.md). |
