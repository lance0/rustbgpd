...
Compact M36-M76 index (details and assertions stay in
...
| Other M41-M76 rows in this span | Foundation interop receipts such as BLACKHOLE FIB discard, gRPC/gNMI, EVPN Type 5 injection, BGP Roles/ORF/ASPA, inbound backpressure, IPv6-only peering, BGP-LS reflection, VPNv4 route-reflection, RT-Constrain VPNv4 filtering, and RFC 9107 ORR divergent-best remain catalogued in `INTEROP.md`. |
