...
Compact M36-M75 index (details and assertions stay in
...
| Other M41-M75 rows in this span | Foundation interop receipts such as BLACKHOLE FIB discard, gRPC/gNMI, EVPN Type 5 injection, BGP Roles/ORF/ASPA, inbound backpressure, IPv6-only peering, BGP-LS reflection, VPNv4 route-reflection, and RT-Constrain VPNv4 filtering remain catalogued in `INTEROP.md`. |
