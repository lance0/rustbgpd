...
| Distribution fanout | Pinned A/B receipt | Real per-session exact-probe baseline vs prepared-attribute memo, with 18%..32% gains, full confidence intervals, reproduction commands, and checked-in CSV: [`perf/exact-export-fanout-2026-07.md`](perf/exact-export-fanout-2026-07.md). |
