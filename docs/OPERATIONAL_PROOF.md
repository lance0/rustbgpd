...
| M43 | Conditional TCP-AO queued-child receipt plus full no-flap add/select/deprecate/delete rotation against BIRD with a 100 ms route-continuity polling oracle; probed and skipped only when the selected runner kernel lacks support. |
