...
- Full production EVPN **VTEP** deployments — rustbgpd now ships the
  ...
  multi-homing alpha support. IRB / L3VNI / Type 5 dataplane,
  aliasing dataplane ECMP, and production-default multi-homing
  enforcement are still ahead
...
| **Not yet supported** | Kernel FIB integration (unicast), EVPN duplicate-MAC quarantine action / IRB / L3VNI / Type 5 dataplane / aliasing dataplane ECMP / production-default multi-homing enforcement, VPNv4/v6, Confederation, TCP-AO |
