...
- Full production EVPN **VTEP** deployments — rustbgpd now ships the
  ...
  and sub-second mobility convergence (Gate 7c). DF election,
  IRB / L3VNI / Type 5 dataplane, and multi-homing are still deferred
...
| **Not yet supported** | Kernel FIB integration (unicast), EVPN duplicate-MAC quarantine action / DF election / IRB / L3VNI / Type 5 dataplane / local VTEP multi-homing execution, VPNv4/v6, Confederation, TCP-AO |
