...
| Interop suites | Automated interop suite (see [docs/INTEROP.md](docs/INTEROP.md) for the full matrix), primarily against FRR 10.7.1 plus GoBGP 3.37.0 / 4.6.0 / 4.7.0 across established labs; M76/M77/M83/M103/M104 use GoBGP 4.8.0, which also appears in the local M105 observation, M83 uses FRR 10.7.0, and the digest-pinned M89/M99/M100/M101/M102/M105 legs stay on FRR 10.3.1. StayRTR backs RTR coverage; BIRD 2.0.12 anchors M0 and immutable legacy/differential labs, BIRD 2.19.2 covers M83/M85/M93/M95/M100/M104, and BIRD 3.3.2 covers the M43 TCP-AO smoke, M101, plus local M105. A foundation tier is gated on every PR, privileged Linux dataplane smokes run in hosted kernel-dataplane CI, and longer soaks / platform-diversity scripts remain local. |
