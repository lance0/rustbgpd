...
| `EventService` | `WatchEvents` | Unified live stream for route events and session lifecycle events; policy and dataplane categories remain reserved, with EVPN and BGP NOTIFICATION event sources deferred |
