...
- Full production EVPN **VTEP** deployments — rustbgpd now ships the
  ...
  IRB datapath against FRR 10.3.1. Aliasing dataplane ECMP and
  production-default multi-homing enforcement are still ahead
...
| **Not yet supported** | Kernel FIB integration (unicast), EVPN duplicate-MAC quarantine action / aliasing dataplane ECMP / production-default multi-homing enforcement / RFC 9135 overlay-index IRB, VPNv4/v6, Confederation, TCP-AO |
