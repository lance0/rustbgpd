...
- [x] **Memory profiling** — tracking allocator test measures per-route footprint: 588 B/route typical, 1.8 GB for full table (900k x 2 peers + LocRib); 4-9x less than GoBGP, path attribute interning identified as next optimization
