...
- [ ] **Finer-grained gRPC authorization** — ADR-0064 now has a checked
  ...
  `[security.grpc.roles]`, and explicit non-mTLS listener principal labels.
  Remaining work: mTLS certificate principal extraction, listener `max_tier`,
  deny-by-tier enforcement, and hardened result/request audit records.
