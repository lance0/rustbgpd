...
- [ ] **EVPN VTEP alpha-soak slate.** With Gates 7a / 7b / 7b+1 /
  ...
  slice 6 symmetric Interface-less IRB end-to-end live (PR A
  origination + PR B import + M39 manual smoke against FRR 10.3.1),
