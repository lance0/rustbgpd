...
complete -c rbgp -n "__fish_rbgp_using_subcommand config; and not __fish_seen_subcommand_from diff plan apply confirm abort status history rollback effective import help" -f -a "plan" -d 'Validate and classify a candidate transaction without mutation'
complete -c rbgp -n "__fish_rbgp_using_subcommand config; and not __fish_seen_subcommand_from diff plan apply confirm abort status history rollback effective import help" -f -a "apply" -d 'Commit a previously planned candidate transaction'
complete -c rbgp -n "__fish_rbgp_using_subcommand config; and not __fish_seen_subcommand_from diff plan apply confirm abort status history rollback effective import help" -f -a "confirm" -d 'Confirm a pending confirmed config transaction'
complete -c rbgp -n "__fish_rbgp_using_subcommand config; and not __fish_seen_subcommand_from diff plan apply confirm abort status history rollback effective import help" -f -a "abort" -d 'Abort a pending confirmed config transaction and roll back immediately'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand config; and __fish_seen_subcommand_from rollback" -l client-request-id -d 'Optional audit/correlation identifier' -r
complete -c rbgp -n "__fish_rbgp_using_subcommand config; and __fish_seen_subcommand_from rollback" -l comment -d 'Optional human change note; not logged verbatim by the daemon' -r
complete -c rbgp -n "__fish_rbgp_using_subcommand config; and __fish_seen_subcommand_from rollback" -l confirm-id -d 'Optional confirmed-commit handle; requires explicit confirm/abort' -r
...
complete -c rbgp -n "__fish_rbgp_using_subcommand neighbor; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "delete" -d 'Delete this neighbor'
complete -c rbgp -n "__fish_rbgp_using_subcommand neighbor; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "enable" -d 'Enable this neighbor'
complete -c rbgp -n "__fish_rbgp_using_subcommand neighbor; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "disable" -d 'Disable this neighbor'
complete -c rbgp -n "__fish_rbgp_using_subcommand neighbor; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "reset" -d 'Reset this neighbor\'s session (static peers retry; dynamic peers reconnect inbound)'
complete -c rbgp -n "__fish_rbgp_using_subcommand neighbor; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "softreset" -d 'Trigger soft reset (inbound)'
complete -c rbgp -n "__fish_rbgp_using_subcommand neighbor; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "refresh-out" -d 'Re-send this peer\'s current exportable outbound routes'
complete -c rbgp -n "__fish_rbgp_using_subcommand neighbor; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "replay-out" -d 'Replay this peer\'s negotiated IPv4/IPv6 unicast routes with terminal UPDATE EoRs'
complete -c rbgp -n "__fish_rbgp_using_subcommand neighbor; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand neighbor; and __fish_seen_subcommand_from help" -f -a "reset" -d 'Reset this neighbor\'s session (static peers retry; dynamic peers reconnect inbound)'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand neighbor; and __fish_seen_subcommand_from help" -f -a "replay-out" -d 'Replay this peer\'s negotiated IPv4/IPv6 unicast routes with terminal UPDATE EoRs'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand summary; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "delete" -d 'Delete this neighbor'
complete -c rbgp -n "__fish_rbgp_using_subcommand summary; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "enable" -d 'Enable this neighbor'
complete -c rbgp -n "__fish_rbgp_using_subcommand summary; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "disable" -d 'Disable this neighbor'
complete -c rbgp -n "__fish_rbgp_using_subcommand summary; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "reset" -d 'Reset this neighbor\'s session (static peers retry; dynamic peers reconnect inbound)'
complete -c rbgp -n "__fish_rbgp_using_subcommand summary; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "softreset" -d 'Trigger soft reset (inbound)'
complete -c rbgp -n "__fish_rbgp_using_subcommand summary; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "refresh-out" -d 'Re-send this peer\'s current exportable outbound routes'
complete -c rbgp -n "__fish_rbgp_using_subcommand summary; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "replay-out" -d 'Replay this peer\'s negotiated IPv4/IPv6 unicast routes with terminal UPDATE EoRs'
complete -c rbgp -n "__fish_rbgp_using_subcommand summary; and not __fish_seen_subcommand_from add delete enable disable reset softreset refresh-out replay-out help" -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand summary; and __fish_seen_subcommand_from help" -f -a "reset" -d 'Reset this neighbor\'s session (static peers retry; dynamic peers reconnect inbound)'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand summary; and __fish_seen_subcommand_from help" -f -a "replay-out" -d 'Replay this peer\'s negotiated IPv4/IPv6 unicast routes with terminal UPDATE EoRs'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand rpki; and not __fish_seen_subcommand_from aspa verify-path caches validate help" -f -a "verify-path" -d 'Verify a literal effective AS_PATH for hypothetical eBGP unicast ingress'
complete -c rbgp -n "__fish_rbgp_using_subcommand rpki; and not __fish_seen_subcommand_from aspa verify-path caches validate help" -f -a "caches" -d 'List configured RTR caches and accepted validation epochs'
complete -c rbgp -n "__fish_rbgp_using_subcommand rpki; and not __fish_seen_subcommand_from aspa verify-path caches validate help" -f -a "validate" -d 'Validate one CIDR prefix and origin ASN'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand rpki; and __fish_seen_subcommand_from verify-path" -l role -d 'Local receiving role; none selects unconfigured-role upstream behavior' -r -f -a "none\t''
provider\t''
customer\t''
peer\t''
route-server\t''
...
complete -c rbgp -n "__fish_rbgp_using_subcommand rpki; and __fish_seen_subcommand_from help" -f -a "verify-path" -d 'Verify a literal effective AS_PATH for hypothetical eBGP unicast ingress'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand rib; and not __fish_seen_subcommand_from lookup received recv advertised sent blackholes fib bgpls bgp-ls vpn labeled rtc add delete help" -l rpki-state -d 'Filter by recorded RPKI verdict' -r -f -a "valid\t''
invalid\t''
not_found\t''"
complete -c rbgp -n "__fish_rbgp_using_subcommand rib; and not __fish_seen_subcommand_from lookup received recv advertised sent blackholes fib bgpls bgp-ls vpn labeled rtc add delete help" -l aspa-state -d 'Filter by recorded ASPA verdict' -r -f -a "valid\t''
invalid\t''
unknown\t''"
...
complete -c rbgp -n "__fish_rbgp_using_subcommand rib; and not __fish_seen_subcommand_from lookup received recv advertised sent blackholes fib bgpls bgp-ls vpn labeled rtc add delete help" -f -a "received" -d 'Show received routes from a neighbor'
complete -c rbgp -n "__fish_rbgp_using_subcommand rib; and not __fish_seen_subcommand_from lookup received recv advertised sent blackholes fib bgpls bgp-ls vpn labeled rtc add delete help" -f -a "recv" -d 'Show received routes from a neighbor'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand rib; and not __fish_seen_subcommand_from lookup received recv advertised sent blackholes fib bgpls bgp-ls vpn labeled rtc add delete help" -f -a "labeled" -d 'Show IPv4/IPv6 labeled-unicast routes learned from peers (RFC 8277)'
complete -c rbgp -n "__fish_rbgp_using_subcommand rib; and not __fish_seen_subcommand_from lookup received recv advertised sent blackholes fib bgpls bgp-ls vpn labeled rtc add delete help" -f -a "rtc" -d 'Show RT-Constrain routes (RFC 4684, single IPv4 family)'
complete -c rbgp -n "__fish_rbgp_using_subcommand rib; and not __fish_seen_subcommand_from lookup received recv advertised sent blackholes fib bgpls bgp-ls vpn labeled rtc add delete help" -f -a "add" -d 'Inject a route'
complete -c rbgp -n "__fish_rbgp_using_subcommand rib; and not __fish_seen_subcommand_from lookup received recv advertised sent blackholes fib bgpls bgp-ls vpn labeled rtc add delete help" -f -a "delete" -d 'Withdraw a route'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and not __fish_seen_subcommand_from received advertised explain add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac duplicate-mac-quarantines es runtime instances nexthops managed-netdevs vrfs diagnose help" -f -a "advertised" -d 'Committed EVPN routes advertised to a peer (rows retain their source peer)'
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and not __fish_seen_subcommand_from received advertised explain add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac duplicate-mac-quarantines es runtime instances nexthops managed-netdevs vrfs diagnose help" -f -a "explain" -d 'Explain one exact EVPN key, its selection, and optional export destination'
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and not __fish_seen_subcommand_from received advertised explain add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac duplicate-mac-quarantines es runtime instances nexthops managed-netdevs vrfs diagnose help" -f -a "add-mac-ip" -d 'Inject a Type 2 MAC/IP route'
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and not __fish_seen_subcommand_from received advertised explain add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac duplicate-mac-quarantines es runtime instances nexthops managed-netdevs vrfs diagnose help" -f -a "add-imet" -d 'Inject a Type 3 IMET route'
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and not __fish_seen_subcommand_from received advertised explain add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac duplicate-mac-quarantines es runtime instances nexthops managed-netdevs vrfs diagnose help" -f -a "add-ip-prefix" -d 'Inject a Type 5 IP Prefix route'
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and not __fish_seen_subcommand_from received advertised explain add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac duplicate-mac-quarantines es runtime instances nexthops managed-netdevs vrfs diagnose help" -f -a "delete-mac-ip" -d 'Withdraw a Type 2 MAC/IP route by its key fields'
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and not __fish_seen_subcommand_from received advertised explain add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac duplicate-mac-quarantines es runtime instances nexthops managed-netdevs vrfs diagnose help" -f -a "delete-imet" -d 'Withdraw a Type 3 IMET route by its key fields'
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and not __fish_seen_subcommand_from received advertised explain add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac duplicate-mac-quarantines es runtime instances nexthops managed-netdevs vrfs diagnose help" -f -a "delete-ip-prefix" -d 'Withdraw a Type 5 IP Prefix route by its key fields'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and __fish_seen_subcommand_from explain" -f -a "ip-prefix" -d 'Type 5: exact canonical prefix; nonzero Ethernet Tags are supported'
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and __fish_seen_subcommand_from explain" -f -a "ead-per-es" -d 'Type 1 per-ES: the Ethernet Tag is always MAX_ET'
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and __fish_seen_subcommand_from explain" -f -a "ead-per-evi" -d 'Type 1 per-EVI: MAX_ET is not a per-EVI key'
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and __fish_seen_subcommand_from explain" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and __fish_seen_subcommand_from help" -f -a "advertised" -d 'Committed EVPN routes advertised to a peer (rows retain their source peer)'
complete -c rbgp -n "__fish_rbgp_using_subcommand evpn; and __fish_seen_subcommand_from help" -f -a "explain" -d 'Explain one exact EVPN key, its selection, and optional export destination'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand policy; and __fish_seen_subcommand_from check" -l max-graph-bytes -d 'Total source-byte budget for the resolved import graph — mirror of the daemon\'s `[policy] rpol_max_graph_bytes` (default 256 MiB). Set this to match a daemon whose budget was raised, so the offline verdict matches the daemon\'s' -r
complete -c rbgp -n "__fish_rbgp_using_subcommand policy; and __fish_seen_subcommand_from check" -l coverage-min -d 'Minimum acceptable exercised-term percentage, from 0 through 100 (implies --coverage): exit 3 when coverage falls below PCT (CI gate). Diagnostics (1) and test failures (2) take precedence' -r
...
complete -c rbgp -n "__fish_rbgp_using_subcommand help; and __fish_seen_subcommand_from neighbor" -f -a "reset" -d 'Reset this neighbor\'s session (static peers retry; dynamic peers reconnect inbound)'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand help; and __fish_seen_subcommand_from neighbor" -f -a "replay-out" -d 'Replay this peer\'s negotiated IPv4/IPv6 unicast routes with terminal UPDATE EoRs'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand help; and __fish_seen_subcommand_from rpki" -f -a "aspa" -d 'Look up one customer\'s merged ASPA provider set'
complete -c rbgp -n "__fish_rbgp_using_subcommand help; and __fish_seen_subcommand_from rpki" -f -a "verify-path" -d 'Verify a literal effective AS_PATH for hypothetical eBGP unicast ingress'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand help; and __fish_seen_subcommand_from rib" -f -a "lookup" -d 'Find the longest-prefix match in the global best-route table'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand help; and __fish_seen_subcommand_from evpn" -f -a "advertised" -d 'Committed EVPN routes advertised to a peer (rows retain their source peer)'
complete -c rbgp -n "__fish_rbgp_using_subcommand help; and __fish_seen_subcommand_from evpn" -f -a "explain" -d 'Explain one exact EVPN key, its selection, and optional export destination'
