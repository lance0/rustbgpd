...
complete -c rbgp -n "__fish_rbgp_using_subcommand config; and not __fish_seen_subcommand_from diff plan apply confirm abort status history rollback effective import help" -f -a "rollback" -d 'Roll back to an eligible legacy config snapshot (Junos `rollback N`)'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand config; and __fish_seen_subcommand_from help" -f -a "rollback" -d 'Roll back to an eligible legacy config snapshot (Junos `rollback N`)'
...
complete -c rbgp -n "__fish_rbgp_using_subcommand help; and __fish_seen_subcommand_from config" -f -a "rollback" -d 'Roll back to an eligible legacy config snapshot (Junos `rollback N`)'
