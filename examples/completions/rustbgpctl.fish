...
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "global" -d 'Show daemon global configuration'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "neighbor" -d 'Manage BGP neighbors'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "rib" -d 'Query and manage the RIB'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "flowspec" -d 'Manage FlowSpec routes'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "evpn" -d 'Manage EVPN routes (list, add, delete — RFC 7432)'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "watch" -d 'Watch route updates (streaming)'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "health" -d 'Check daemon health'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "metrics" -d 'Show Prometheus metrics'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "shutdown" -d 'Request daemon shutdown'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "mrt-dump" -d 'Trigger an on-demand MRT dump'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "gshut" -d 'Toggle the RFC 8326 GRACEFUL_SHUTDOWN community on outbound updates for one peer (`--peer X`) or every currently-managed peer (omit `--peer`). Receivers that honor RFC 8326 will set local_pref = 0 on tagged paths, draining traffic ahead of planned maintenance'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "top" -d 'Live TUI dashboard'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "policy" -d 'Manage named `[[policy_definitions]]` entries and the global / per-neighbor import/export chains. Backed by PolicyService'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "neighbor-set" -d 'Manage named `[[neighbor_sets]]` entries used by policy `match_neighbor_set`. Backed by PolicyService'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "peer-group" -d 'Manage named `[[peer_groups]]` entries and bind/unbind neighbors to them. Backed by PeerGroupService'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "completions" -d 'Generate shell completions'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and not __fish_seen_subcommand_from global neighbor rib flowspec evpn watch health metrics shutdown mrt-dump gshut top policy neighbor-set peer-group completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
