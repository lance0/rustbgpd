...
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand config; and __fish_seen_subcommand_from apply" -l confirm-timeout -d 'Confirmed-commit timeout in seconds; daemon default is 600, max is 86400' -r
...
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -l route-type -d 'Route type filter (1..=5) — applies when no subcommand is given' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -l peer -d 'Peer IP address filter (list mode only)' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -l rd -d 'Route Distinguisher filter (list mode only), e.g. "65000:100"' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -s s -l addr -d 'gRPC server address or unix:///path/to/socket' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -l token-file -d 'Bearer token file for authenticated gRPC endpoints' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -s j -l json -d 'Output in JSON format'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -l no-color -d 'Disable colored output'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "list" -d 'List EVPN routes (default action — same as omitting the subcommand)'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "add-mac-ip" -d 'Inject a Type 2 MAC/IP route'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "add-imet" -d 'Inject a Type 3 IMET route'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "add-ip-prefix" -d 'Inject a Type 5 IP Prefix route'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "delete-mac-ip" -d 'Withdraw a Type 2 MAC/IP route by its key fields'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "delete-imet" -d 'Withdraw a Type 3 IMET route by its key fields'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "delete-ip-prefix" -d 'Withdraw a Type 5 IP Prefix route by its key fields'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "clear-duplicate-mac" -d 'Clear one duplicate-MAC local-origin quarantine'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "es" -d 'Ethernet Segment runtime controls and diagnose state'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "runtime" -d 'Show the committed ADR-0063 EVPN runtime generation'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "instances" -d 'List local EVPN instances configured on this VTEP. Empty when the daemon is acting purely as an EVPN route reflector'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "nexthops" -d 'List rustbgpd-owned FDB nexthop groups (ADR-0059 aliasing ECMP)'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "vrfs" -d 'List configured IP-VRFs (Gate 9, ADR-0058) and their readiness verdict from the most recent reconcile pass'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "diagnose" -d 'Summarize EVPN VTEP alpha state and key metrics'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and not __fish_seen_subcommand_from list add-mac-ip add-imet add-ip-prefix delete-mac-ip delete-imet delete-ip-prefix clear-duplicate-mac es runtime instances nexthops vrfs diagnose help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and __fish_seen_subcommand_from es" -s s -l addr -d 'gRPC server address or unix:///path/to/socket' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and __fish_seen_subcommand_from es" -l token-file -d 'Bearer token file for authenticated gRPC endpoints' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and __fish_seen_subcommand_from es" -s j -l json -d 'Output in JSON format'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and __fish_seen_subcommand_from es" -l no-color -d 'Disable colored output'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and __fish_seen_subcommand_from es" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and __fish_seen_subcommand_from es" -f -a "list" -d 'List configured Ethernet Segments joined with live drain, DF/AC-gate, same-ESI bias, and FDB-NHG state'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and __fish_seen_subcommand_from es" -f -a "drain" -d 'Drain an Ethernet Segment before access-circuit maintenance: withdraw its Type 4 + EAD routes (exiting DF election) and the member VNIs\' local Type 2 routes, and suppress new local-MAC origination. In-memory only — a daemon restart clears the drain'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and __fish_seen_subcommand_from es" -f -a "undrain" -d 'Undrain an Ethernet Segment: re-originate its Type 4 + EAD routes, re-run DF election, and replay cached local MAC state'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and __fish_seen_subcommand_from es" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand evpn; and __fish_seen_subcommand_from help" -f -a "es" -d 'Ethernet Segment runtime controls and diagnose state'
...
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from sessions" -l address -d 'Neighbor address filter' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from sessions" -l type -d 'Session event type filter: state_changed, established, lost, peer_enabled, peer_disabled' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from sessions" -s l -l limit -d 'Maximum recent session events to return (default 100; explicit 0 requests the daemon\'s full bounded window)' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from sessions" -s s -l addr -d 'gRPC server address or unix:///path/to/socket' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from sessions" -l token-file -d 'Bearer token file for authenticated gRPC endpoints' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from sessions" -s j -l json -d 'Output in JSON format'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from sessions" -l no-color -d 'Disable colored output'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from sessions" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from policy" -l address -d 'Neighbor address filter. Only peer-scoped policy events match' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from policy" -l type -d 'Policy event type filter: policy_changed' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from policy" -s l -l limit -d 'Maximum recent policy events to return (default 100; explicit 0 requests the daemon\'s full bounded window)' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from policy" -s s -l addr -d 'gRPC server address or unix:///path/to/socket' -r
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand events; and __fish_seen_subcommand_from policy" -l token-file -d 'Bearer token file for authenticated gRPC endpoints' -r
...
complete -c rustbgpctl -n "__fish_rustbgpctl_using_subcommand help; and __fish_seen_subcommand_from evpn" -f -a "es" -d 'Ethernet Segment runtime controls and diagnose state'
