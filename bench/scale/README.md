...
| [`rrtransport/`](rrtransport/) | Fixed two-peer real-transport RR correctness smoke (production sessions, shared update group, exact staged and wire sets) | CI foundation only; not a performance receipt |
