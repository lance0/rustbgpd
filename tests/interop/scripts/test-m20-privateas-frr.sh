...
main() {
    ...
    wait_frr_established "$FRR_SOURCE" "10.0.0.1" "$FRR_SOURCE" || true
    wait_frr_established "$FRR_REMOVE" "10.0.1.1" "$FRR_REMOVE" || true
    wait_frr_established "$FRR_ALL" "10.0.2.1" "$FRR_ALL" || true
    wait_frr_established "$FRR_REPLACE" "10.0.3.1" "$FRR_REPLACE" || true
