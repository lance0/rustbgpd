#!/usr/bin/env bash
# M46 smoke — RFC 8584 §3.2 Highest Random Weight DF election against a
...
# below a positive proof that HRW is in effect, not modulo.
#
# Asserts:
...
assert "PE1 reports DF=0 (HRW loser; modulo would have made it DF)" \
...
echo "Stopping PE2 (the HRW DF) to force DF promotion on PE1..."
...
echo ""
echo "M46 smoke: $PASS/$TOTAL passed, $FAIL failed."
[[ $FAIL -eq 0 ]]
